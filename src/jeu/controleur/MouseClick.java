...
public class MouseClick implements EventHandler<MouseEvent> {
	...
	public void handle(MouseEvent arg0) {
		...
		if (objet instanceof Pioche && arg0.getButton() == MouseButton.PRIMARY  ) {
			...
			terrainVue.changementTuileMinage(positionTuileDansTableau,env.getTerrain(),Parametre.blocBois);// changer et faire une fonction qui actualise juste l'image chang�			}
		}
