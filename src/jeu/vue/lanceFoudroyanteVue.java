...
//		
//		lance.getCoordonneeX().addListener((obs,old,newP) -> {
//			this.setLayoutX(lance.getX());
//		});
//		
//		lance.getCoordonneeY().addListener((obs,old,newP) -> {
//			System.out.println("ahhhhhhahhah");
//			this.setLayoutY(lance.getY());
//		});
//	}
	...
	public void affichageTitan(LanceFoudroyante lance) {
		...
		System.out.println("\n Affichage du x lance" + xProperty().getValue());
		System.out.println("\n Affichage du x lance" + yProperty().getValue());
