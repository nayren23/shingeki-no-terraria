...
public class InventaireVue extends Pane{
	...
	public InventaireVue(Inventaire inventaire, TilePane inv, TilePane obj,Heros eren) {
		...
		this.tableauImage = new Image [12];
...
//		this.tableauImage[12]= new ImageView (new Image("jeu/image/inventaire/terreInventaire.png"));
//		this.tableauImage[13]= new ImageView (new Image("jeu/image/inventaire/terreInventaire.png"));
