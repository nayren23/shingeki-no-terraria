...
public class TerrainVue {
	...
	// On cr�er les images une seul fois 
...
//	public void changementTuileMinage(int num�roTuile , Terrain terrain) {
//
//		System.out.println("\nhello"+num�roTuile);
//		
//		ImageView img = new ImageView();
//		System.out.println("\nbonjour"+ terrain.getTerrain()[num�roTuile]);
//			if(Terrain.listeBlocMinable().contains (terrain.getTerrain()[num�roTuile] )) {
