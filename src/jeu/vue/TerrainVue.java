...
//	public void changementTuileMinage(int numÈroTuile , Terrain terrain) {
//
//		System.out.println("\nhello"+numÈroTuile);
//		
//		ImageView img = new ImageView();
//		System.out.println("\nbonjour"+ terrain.getTerrain()[numÈroTuile]);
//			if(Terrain.listeBlocMinable().contains (terrain.getTerrain()[numÈroTuile] )) {
